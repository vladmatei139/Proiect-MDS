...
var over = false;
var muted = false;
var eatSound,gameoverSound,gjSound,bgm;

function preload() {
    eatSound = loadSound('../Content/Music/Cut10.wav');
    gameoverSound = loadSound('../Content/Music/voice006.wav');
    gjSound = loadSound('../Content/Music/clap.wav');
    bgm = loadSound('../Content/Music/Ib_Memory.mp3');
}
...
function setup() {
    ...
    instr = createElement('p', 'Sageti: miscati sarpele Space: meniu R: reset');
